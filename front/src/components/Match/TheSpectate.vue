  ...
  <div class="mainContainer">
    <div>
      <span
        ...
        style="opacity: 0.5; margin-left: -60px"
      >
        <i data-v-729845b3="" class="fas fa-circle fa-stack-2x"></i>
        <i
          data-v-729845b3=""
          class="fas fa-square fa-stack-2x"
          style="margin-left: 30px; margin-top: -3px; font-size: 53pt"
        ></i>
        <i
          data-v-729845b3=""
        ...
        <div style="height: 100%">
          <span class="fa-stack fa-2x">
            <i
              ...
              style="font-size: 300px; color: #105869; margin-left: -40px"
            ></i>
            <i
              class="fas fa-table-tennis fa-stack-1x fa-inverse"
              style="
                margin-top: -200px;
                margin-left: 120px;
                font-size: 60px;
        ...
        <div style="height: 100%">
          <span class="fa-stack fa-2x">
            <i
              ...
              style="font-size: 300px; color: #105869; margin-left: -70px"
            ></i>
            <i
              class="fas fa-table-tennis fa-stack-1x fa-inverse fa-flip-horizontal"
              style="
                margin-top: -200px;
                margin-left: -120px;
                font-size: 60px;
    ...
    <div
      v-if="parseInt(isFinished) == 0"
      style="margin: 0 auto; width: 100%; clear: both"
    >
        ...
        <div style="padding-top: 5px; text-align: right; padding-right: 80px">
          <span>
            <span
              v-if="
                !match.isFinished &&
                parseInt(currentServerId) === parseInt(match.homePlayerId)
              "
              class="blinking"
            >
              <span style="font-size: 20px">
                <span
                  v-if="parseInt(this.currentNumServes) === 2"
                  class="blinking"
                >
        ...
        <div style="padding-top: 5px; text-align: left; padding-left: 80px">
          <span>
            <span
              v-if="
                !match.isFinished &&
                parseInt(currentServerId) === parseInt(match.awayPlayerId)
              "
            >
              <span style="font-size: 20px">
                <span
    ...
    <div v-else style="margin: 0 auto; width: 100%; clear: both">
      <div class="container-score-fl">
        <div class="score-left">
          <span class="fa-stack fa-2x">
            <i
              v-if="parseInt(awayScoreTotal) < parseInt(homeScoreTotal)"
              class="fas fa-circle fa-stack-2x"
              style="color: #40c500"
            ></i>
            <i
              v-else-if="parseInt(awayScoreTotal) === parseInt(homeScoreTotal)"
              class="fas fa-circle fa-stack-2x"
              style="color: #7f949a"
            ></i>
            <i
        ...
        <div class="midInfoValue">
          <div class="tableSetScores">
            <div class="set-container-fl">
              <div
                v-for="(score, index) in matchScores"
                v-bind:key="index"
                class="rowData"
              >
