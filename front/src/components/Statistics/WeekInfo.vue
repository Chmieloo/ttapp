  ...
  <div id="app">
    <div class="mainContainer">
      <table class="top-banner">
        <tr>
          <td class="top-banner-left">Last week's</td>
          <td class="top-banner-right">summary</td>
        </tr>
      </table>
      <table style="width: 90%; margin: 30px auto">
        <tr>
          ...
          >
            <table>
              <tr>
                <td style="font-size: 80px; color: white">
                  {{ data.gamesCount }}
                </td>
                ...
                <td style="font-size: 80px; color: white; padding-left: 20px">
                  {{ data.playersCount }}
                </td>
                <td style="font-size: 20px">
                  <div>unique</div>
              ...
              <tr>
                <td colspan="6" style="font-size: 20px">
                  with total
                  <span style="color: white; font-size: 150px">{{
                    data.totalPoints
                  }}</span>
                  points !!!
                </td>
              ...
              <tr>
                ...
                <td style="font-size: 20px; width: 60%; padding-left: 20px">
                  <div style="font-size: 80px; color: white">
                    {{ parseFloat(data.scoutedPercentage).toFixed(2) }}%
                  </div>
              ...
              <tr>
                <td style="padding-left: 20px">
                  ...
                  <div style="font-size: 60px; color: white">
                    +{{ data.eloPlusValue }} ELO
                  </div>
                  <div style="font-size: 30px">
                    {{ data.eloPlusPlayerName }}
                  </div>
                </td>
                <td>
                  <span
                    style="font-size: 150px; color: white; padding-left: 30px"
                  >
            ...
            <table style="margin-top: 20px">
              <tr>
                ...
                <td style="padding-left: 20px">
                  ...
                  <div style="font-size: 60px; color: white">
                    {{ data.eloMinusValue }} ELO
                  </div>
                  <div style="font-size: 30px">
                    {{ data.eloMinusPlayerName }}
                  </div>
                </td>
              </tr>
            </table>
