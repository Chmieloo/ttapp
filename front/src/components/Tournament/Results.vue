    ...
    <table>
      ...
      >
        ...
        <td
          class="txt-right"
          v-bind:class="
            match.winnerId == match.homePlayerId ? 'winner-color' : ''
          "
        >
        ...
        <td
          v-bind:class="
            match.winnerId == match.awayPlayerId ? 'winner-color' : ''
          "
        >
        ...
        <td>
          ...
          <span v-if="match.isWalkover == '1'"> walkover </span>
...
export default {
  ...
  mounted() {
    axios
      .get("/api/tournaments/" + this.$route.params.id + "/results/0")
      .then((res) => {
