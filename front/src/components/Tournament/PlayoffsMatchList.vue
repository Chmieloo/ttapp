  ...
  <div class="mainContainer">
    <table style="width: 100%; margin-bottom: 20px">
      <tr>
          ...
          <router-link to="/playoffs/ladders" tag="div" class="playoffBanner">
            <div style="width: 100%; text-align: center">
              <div style="margin-bottom: 10px">
                <span class="header-title"> SHOW ALL LADDERS </span>
              </div>
              <div>
                <span class="fa-stack">
                  <i
        ...
        <td style="padding-right: 20px; width: 25%">
          <router-link
            to="/playoffs/group/8/ladder"
            tag="div"
            class="playoffBanner"
          >
            <div style="width: 100%; text-align: center">
              <div style="margin-bottom: 10px">
                <span class="header-title"> PREMIER LEAGUE LADDER </span>
              </div>
              <div>
                <span class="fa-stack">
                  <i class="fas fa-shield-alt fa-stack-2x stack-shield"></i>
                  <i
                    class="fas fa-shield-alt fa-stack-2x stack-shield-reversed"
                  ></i>
        ...
        <td style="padding-right: 20px; width: 25%">
          <router-link
            to="/playoffs/group/9/ladder"
            tag="div"
            class="playoffBanner"
          >
            <div style="width: 100%; text-align: center">
              <div style="margin-bottom: 10px">
                <span class="header-title"> CHAMPIONSHIP LADDER </span>
              </div>
              <div>
                <span class="fa-stack">
                  <i class="fas fa-shield-alt fa-stack-2x stack-shield"></i>
        ...
        <td style="width: 25%">
          <router-link
            to="/playoffs/group/10/ladder"
            tag="div"
            class="playoffBanner"
          >
            <div style="width: 100%; text-align: center">
              <div style="margin-bottom: 10px">
                <span class="header-title"> CONFERENCE LADDER </span>
              </div>
              <div>
                <span class="fa-stack">
                  <i class="fas fa-shield-alt fa-stack-2x stack-shield"></i>
    ...
    <span class="header-title">
      ...
      PLAYOFFS SCHEDULE
      <span style="margin-left: 40px">( * TO BE DECIDED )</span>
    </span>
        ...
        <tr v-for="match in matches" v-bind:key="match.id" class="row-data">
          ...
          <td
            ...
            v-if="
              playoffs &&
              !match.winnerId &&
              match.homePlayerId != 0 &&
              match.awayPlayerId != 0
            "
          >
            <router-link
