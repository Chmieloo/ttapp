    ...
    <table style="width: 100%; border-spacing: 30px; border-collapse: separate">
      <tr>
        <td colspan="3" style="font-size: 25pt">
          <div class="cutoff">
            <span style="font-weight: 600; color: white">TOP 5</span> POINTS
            SCORERS
          </div>
        </td>
      </tr>
      <tr>
        <td style="width: 33%">
          <div class="container">
            ...
            <div style="margin-top: 10px">
              <div
                v-for="(leader, index) in filteredAllTimePointLeaders"
                v-bind:key="leader.id"
                class="row-item"
              >
                <router-link :to="'/player/' + leader.id + '/info'"
                  >{{ index + 1 }}. {{ leader.name }}</router-link
                >
          ...
          <div class="container">
            ...
            <div style="margin-top: 10px">
              <div
                v-for="(
                  leader, index
                ) in filteredCurrentTournamentPointsLeaders"
                v-bind:key="leader.id"
                class="row-item"
              >
                <router-link :to="'/player/' + leader.id + '/info'"
        ...
        <td style="width: 33%">
          <div class="container">
            ...
            <div style="margin-top: 10px">
              <div
                v-for="(leader, index) in filteredLastWeekPointsLeaders"
                v-bind:key="leader.id"
                class="row-item"
              >
                <router-link :to="'/player/' + leader.id + '/info'"
      ...
      <tr>
        <td colspan="3" style="font-size: 25pt">
          <div class="cutoff">
            <span style="font-weight: 600; color: white">TOP 5</span> AVERAGE
            POINTS ADVANTAGE
          </div>
        </td>
      </tr>
      <tr>
        <td style="width: 33%">
          <div class="container">
            ...
            <div style="margin-top: 10px">
              <div
                v-for="(leader, index) in filteredAvgDiffAllTime"
                v-bind:key="leader.id"
                class="row-item"
              >
                <router-link :to="'/player/' + leader.id + '/info'"
                ...
                >
                <span class="fr value">{{
                  parseFloat(leader.avgDiff).toFixed(2)
                }}</span>
              </div>
            </div>
          </div>
        ...
        <td style="width: 33%">
          <div class="container">
            ...
            <div style="margin-top: 10px">
              <div
                v-for="(leader, index) in filteredAvgDiffCurrentTournament"
                v-bind:key="leader.id"
                class="row-item"
              >
                <router-link :to="'/player/' + leader.id + '/info'"
        ...
        <td style="width: 33%">
          <div class="container">
            ...
            <div style="margin-top: 10px">
              <div
                v-for="(leader, index) in filteredAvgDiffLastWeek"
                v-bind:key="leader.id"
                class="row-item"
              >
                <router-link :to="'/player/' + leader.id + '/info'"
      ...
      <tr>
        <td colspan="3" style="font-size: 25pt">
          <div class="cutoff">
            <span style="font-weight: 600; color: white">TOP 5</span> ELO
            LEADERS
          </div>
        </td>
      </tr>
      <tr>
        <td style="width: 33%">
          <div class="container">
            ...
            <div style="margin-top: 10px">
              <div
                v-for="(leader, index) in filteredEloLeaders"
                v-bind:key="leader.id"
                class="row-item"
              >
                <router-link :to="'/player/' + leader.id + '/info'"
        ...
        <td style="width: 33%">
          <div class="container">
            ...
            <div style="margin-top: 10px">
              <div
                v-for="(leader, index) in filteredEloLeadersTournament"
                v-bind:key="leader.id"
                class="row-item"
              >
                <router-link :to="'/player/' + leader.id + '/info'"
                ...
                >
                <span class="fr value"
                  ><span v-if="leader.elodiff > 0">+</span>{{ leader.elodiff }}
                  <span class="valueTelo">({{ leader.telo }})</span></span
                >
              </div>
            </div>
          </div>
        ...
        <td style="width: 33%">
          <div class="container">
            ...
            <div style="margin-top: 10px">
              <div
                v-for="(leader, index) in filteredEloLeadersLastWeek"
                v-bind:key="leader.id"
                class="row-item"
              >
                <router-link :to="'/player/' + leader.id + '/info'"
      ...
      <tr>
        <td colspan="3" style="font-size: 25pt">
          <div class="cutoff">
            <span style="font-weight: 600; color: white">TOP 5</span> SPECTATED
            GAMES
          </div>
        </td>
      </tr>
      <tr>
        <td style="width: 33%">
          <div class="container">
            ...
            <div style="margin-top: 10px">
              <div
                v-for="leader in filteredSpectatorsLeaders"
                v-bind:key="leader.id"
                class="row-item"
              >
                <router-link :to="'/match/' + leader.id + '/summary'"
                  >{{ leader.p1name }} <span style="color: #69797a">vs</span>
                  {{ leader.p2name }}</router-link
                >
        ...
        <td style="width: 33%">
          <div class="container">
            ...
            <div style="margin-top: 10px">
              <div
                v-for="leader in filteredSpectatorsLeadersTournament"
                v-bind:key="leader.id"
                class="row-item"
              >
                <router-link :to="'/match/' + leader.id + '/summary'"
        ...
        <td style="width: 33%">
          <div class="container">
            ...
            <div style="margin-top: 10px">
              <div
                v-for="leader in filteredSpectatorsLeadersLastWeek"
                v-bind:key="leader.id"
                class="row-item"
              >
                <router-link :to="'/match/' + leader.id + '/summary'"
...
export default {
  ...
  mounted() {
    axios.get("/api/leaders").then((res) => {
      ...
      this.currentTournamentPointsLeaders =
        res.data["currentTournamentPointsLeaders"];
      ...
      this.spectatorsLeadersTournament =
        res.data["spectatorsLeadersTournament"];
