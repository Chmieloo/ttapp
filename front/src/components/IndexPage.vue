<template>
  <div class="mainContainer">
    <div v-if="filteredPlayoffs">
      <div
        v-for="playoffsTournament in filteredPlayoffs"
        v-bind:key="playoffsTournament.tournamentId"
      >
          ...
          <table style="width: 100%">
            <tr>
              ...
              >
                <span class="fa-stack" style="font-size: 30px">
                  ...
                  <i
                    class="fas fa-stack-2x fa-medal stack-medal"
                    style="color: black"
                  ></i>
                </span>
              ...
              <td style="vertical-align: top; text-align: right" rowspan="2">
                <div v-if="filteredLiveMatches.length > 0">
                  ...
                  <div
                    v-for="filteredLiveMatch in filteredLiveMatches"
                    v-bind:key="filteredLiveMatch.matchId"
                  >
                    <div style="margin-bottom: 20px">
                      <span style="color: white">{{
                        filteredLiveMatch.homePlayerName
                      }}</span>
                      vs
                      <span style="color: white">{{
                        filteredLiveMatch.awayPlayerName
                      }}</span>
                    </div>
                    <span
                      style="
                    ...
                    >
                      <router-link
                        :to="
                          '/match/' + filteredLiveMatch.matchId + '/spectate'
                        "
            ...
            <tr>
              <td>
                <router-link
                  :to="
                    '/playoffs/' + playoffsTournament.tournamentId + '/ladders'
                  "
                  >ladders</router-link
                >
                |
                <router-link
                  :to="'/playoffs/' + playoffsTournament.tournamentId + '/info'"
